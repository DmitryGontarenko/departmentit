...
create table orders (id int8 not null, created_at timestamp, status integer, tag varchar(255), text varchar(2048), updated_at timestamp, user_id int8, primary key (id));
